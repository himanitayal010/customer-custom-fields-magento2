...
class Add extends \Magento\Checkout\Controller\Cart\Add
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            //Line 1
            if($this->_checkoutSession->getEmbroideryData()){
                $embroidery_data = $this->_checkoutSession->getEmbroideryData();
                $model->setQuoteItemId($quote_item_id);
                $model->setNameEmbroidery($embroidery_data);
                // echo '<pre>'; print_r($model->getNameEmbroidery()); die();
                $model->save();
                $model->unsetData();
